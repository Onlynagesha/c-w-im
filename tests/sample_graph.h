...
// (source, target, p)
inline const auto SAMPLE_EDGES_A_LEFT = std::vector<SampleEdgeTuple>{
    {0, 1, 0.30}, {2, 3, 0.32},       {4, 5, 0.34},       {0, 2, 0.41},
    {2, 4, 0.44}, {6, 0, 0.45045045}, {6, 2, 0.27027027}, {6, 4, 0.27927927},
};

// (source, target, p)
inline const auto SAMPLE_EDGES_A_RIGHT = std::vector<SampleEdgeTuple>{
    {0, 1, 0.31}, {2, 3, 0.33}, {4, 5, 0.35},   {0, 2, 0.42},     {2, 4, 0.45},
    {2, 0, 0.20}, {4, 2, 0.21}, {6, 0, 0.3125}, {6, 2, 0.333333}, {6, 4, 0.354167},
};

// (source, target, p)
inline auto SAMPLE_EDGES_B = std::vector<SampleEdgeTuple>{
    {1, 2, 0.3}, {1, 3, 0.4}, {3, 2, 0.5}, {2, 4, 0.6}, {3, 5, 0.7}, {4, 5, 0.8},
};
